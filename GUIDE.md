...
```bash
VERSION=4.1.0 ./scripts/package/macos/build_pkg.sh      # macOS only
VERSION=4.1.0 ./scripts/package/windows/build_zip.sh    # needs 7z
VERSION=4.1.0 ./scripts/package/linux/build_packages.sh # needs build deps + nfpm
```
